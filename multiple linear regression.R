...
# p value defines tha there is at least one value of X which predicts the value of Y at some extent. and it should be less than 0.05
...
plot(y=omni$sales, x=omni$price)
